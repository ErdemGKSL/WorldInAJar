package tr.erdemdev.worldInAJar.adapter.v26_1_1.paper;
...
import tr.erdemdev.worldInAJar.adapter.v26_1_1.AbstractRuntimeAdapter;
...
public final class PaperRuntimeAdapter extends AbstractRuntimeAdapter {
    ...
    public World createInteriorWorld(String worldName, ChunkGenerator generator) {
        // Paper 26.1.1 rejects an empty FLAT preset. The generator already
        // supplies the intentionally blank interior world.
        return createInteriorWorld(worldName, generator, false);
    }
